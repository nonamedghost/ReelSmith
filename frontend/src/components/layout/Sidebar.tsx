...
export const Sidebar: React.FC<SidebarProps> = ({ className = '' }) => {
  ...
  return (
    <aside
      className={`h-screen bg-slate-900 border-r border-slate-800 text-slate-400 flex flex-col justify-between transition-all duration-300 relative z-20 ${isCollapsed ? 'w-20' : 'w-64'
        } ${className}`}
    >
      {/* Sidebar Top Header */}
      <div>
